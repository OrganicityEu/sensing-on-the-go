...
public class TemperatureSensorService extends Service implements SensorEventListener {
    ...
    public void publishResults() {
        try {
            Log.w(TAG, "Temperature: " + temperature);
            ...
            r.add(new Reading(Reading.Datatype.String, jsonObject.toString(), CONTEXT_TYPE + ".LocationSensorService"));
            info.setPayload(r);

            Log.w(TAG, "Temperature:" + info.getPayload());
